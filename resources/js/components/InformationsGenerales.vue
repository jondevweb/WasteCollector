          ...
          <q-card-section >
            <q-tab-panel name="entreprise" v-for="entreprise in item" 
              ...
              <q-field label="Raison sociale" stack-label>
                <div class="self-center full-width no-outline" tabindex="0" style="padding-left: 10px">{{ entreprise.raison_sociale_entreprise}}</div>
                <q-tooltip class="bg-grey-8" anchor="top left" self="bottom left" :offset="[0, 8]">{{ entreprise.raison_sociale_entreprise}}</q-tooltip>
              </q-field>
              <q-field label="SIRET" stack-label>
                <div class="self-center full-width no-outline" tabindex="0" style="padding-left: 10px">{{ entreprise.siret_entreprise}}</div>
                <q-tooltip class="bg-grey-8" anchor="top left" self="bottom left" :offset="[0, 8]">{{ siret_entreprise}}</q-tooltip></q-field>
              <q-field label="Adresse" stack-label>
                <div class="self-center full-width no-outline" tabindex="0" style="padding-left: 10px">{{ entreprise.adresse_administrative_entreprise}}</div>
                <q-tooltip class="bg-grey-8" anchor="top left" self="bottom left" :offset="[0, 8]">{{ entreprise.adresse_administrative_entreprise}}</q-tooltip>
              </q-field>
